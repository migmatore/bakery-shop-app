        ...
        <div class="login-wrapper">
            <form @submit.prevent>
                <div class="form">
                    ...
                    No account? <router-link to="/signup" style="color: #b17901;">Create one</router-link>
                    or <router-link to="/signup" style="color: #b17901;">login as employee.</router-link>
...
export default defineComponent({
    ...
    methods: {
        async login() {
            await LoginService.singin(this.email, this.password).then((response) => {
...
.form {
    ...
    /* box-shadow: 0px 5px 10px 2px #c4c4c433; */
